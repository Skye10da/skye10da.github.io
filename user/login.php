...
<html lang="en">
  <head>
    ...
    <title>Enhance Online Marriage Registration System||Sign in page</title>
        ...
        <div class="row no-gutters">
          <div class="col-lg-5">
            <div>
              ...
              <p>This is section is for the user to register for marriage</p>
...
<div class="form-group mg-b-0" style="padding-top: 0px"><a href="forgot-password.php">Reset password</a></div>
        ...
        <p class="tx-center tx-white-5 tx-12 mg-t-15"><span>Copyright &copy; Enhance Online Marriage Registration System 2022</span></p>
      </div><!-- signin-box -->

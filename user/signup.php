...
<html lang="en">
  <head>
    ...
    <title>Enhancement Of Online Marriage Registration System||Sign Up page</title>
      ...
      <div class="am-signin-box">
        <div class="row no-gutters">
          <div class="col-lg-5">
            <div>
              <h2>EOMRS </h2>
              <p>The Responsive user registration page</p>
...
<div class="form-group">
        ...
        <p class="tx-center tx-white-5 tx-12 mg-t-15">Enhance Online Marriage Registration System Copyright &copy; 2022. All Rights Reserved. Design by Skye</p>
      </div><!-- signin-box -->
